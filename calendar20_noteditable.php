...
<head>
    ...
    <title>Kalender (nicht administrativ)</title>

    <link rel="apple-touch-icon" sizes="180x180" href="apple-touch-icon.png">
    <link rel="icon" type="image/png" sizes="32x32" href="favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="16x16" href="favicon-16x16.png">
    <link rel="stylesheet" href="library/css/calendar20_global.css">
    <style>
/* start event formats */
<?php 
...
-->
<script src="library/javascript/menu_calendar20.js"></script>
...
<script src="library/javascript/Calendar20.js"></script>
