!(function (e, t) {
    ...
    var ee,
        ...
        re = {
            isBrowser: !0,
            classes: { URLSearchParams: "undefined" != typeof URLSearchParams ? URLSearchParams : X, FormData: "undefined" != typeof FormData ? FormData : null, Blob: "undefined" != typeof Blob ? Blob : null },
                ...
                return new Promise(function (t, n) {
                    ...
                    q.isFormData(i) &&
                        (re.isStandardBrowserEnv || re.isStandardBrowserWebWorkerEnv
                            ...
                            ? q.isString((o = a.getContentType())) && a.setContentType(o.replace(/^\s*(multipart\/form-data);+/, "$1"))
                    ...
                    if (
                        (c.open(e.method.toUpperCase(), Y(d, e.params, e.paramsSerializer), !0),
                        (c.timeout = e.timeout),
                        "onloadend" in c
                            ? (c.onloadend = p)
                ...
                r(e, [
                    {
                        ...
                        value: function (e, t) {
                            ...
                            var n = (t = Ce(this.defaults, t)),
                                ...
                                i = n.headers;
                            void 0 !== r && ke.assertOptions(r, { silentJSONParsing: Ue.transitional(Ue.boolean), forcedJSONParsing: Ue.transitional(Ue.boolean), clarifyTimeoutError: Ue.transitional(Ue.boolean) }, !1),
                                null != o && (q.isFunction(o) ? (t.paramsSerializer = { serialize: o }) : ke.assertOptions(o, { encode: Ue.function, serialize: Ue.function }, !0)),
        ...
        q.forEach(["post", "put", "patch"], function (e) {
            function t(t) {
                return function (n, r, o) {
                    return this.request(Ce(o || {}, { method: e, headers: t ? { "Content-Type": "multipart/form-data" } : {}, url: n, data: r }));
                };
            }
